...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { display_in_navbar: @genre.display_in_navbar, name: @genre.name } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { display_in_navbar: @genre.display_in_navbar, name: @genre.name } }
