...
ActiveRecord::Schema.define(version: 2019_06_07_170315) do
  ...
  create_table "active_admin_comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_active_admin_comments_on_user_id"
  end
  ...
  add_foreign_key "active_admin_comments", "users"
